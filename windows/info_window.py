...
class infoWindow(pygame_gui.elements.UIWindow):
    def __init__(self, manager, pos):
        super().__init__((pos),
                         ...
                         draggable=True)
        self.scroll_box = pygame_gui.elements.UITextBox("""Welcome to the world of Kingdom Cards!
Get ready to dive into a high risk, high reward game – where fortunes are made, bluffs are called, and every card is a potential game-changer.
...
Before the first card even thinks about hitting the table, two players must make a small blind and a big blind bet. It's like tossing a couple of coins into the pot, stirring up the excitement for the round.
...
If your hand trumps the rest, you snatch the pot of chips right from under their noses. If your hand loses, say goodbye to the chips you've put in the pot. But don't worry, there's still ways to win it back!

Chapter 7: Rinse and Repeat
The thrill doesn't stop! Shuffle the deck, deal the cards, and let the frenzy continue. The more you play, the more you'll master the art of reading opponents, crafting sneaky strategies, and taking big risks!

Congratulations, you've now learned the basics of the game - where luck meets skill, and every round is unpredictable. May the cards be ever in your favor!""",
